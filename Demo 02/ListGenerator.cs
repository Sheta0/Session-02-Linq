...
namespace Demo_02
{
    class ProductCompareUnitsInStock : IComparer<Product>
    {
        public int Compare(Product? x, Product? y)
            => x.UnitsInStock.CompareTo(y.UnitsInStock);
    }
    class ProductCompareNameLength : IComparer<string>
    {
    ...
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            string filePath = Path.Combine(projectDirectory, "XML/Customers.xml");
